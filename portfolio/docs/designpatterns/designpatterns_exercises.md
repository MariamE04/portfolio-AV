...
- Test i `Main` at du kan bruge dine klasser og sætte dem sammen som du vil. 
...
Kig på klasserne `Task` og `TaskGroup` i pakken `exercises.composite`. 
...
## 4. Refaktorér med et pattern

Vælg ét af de steder du fandt i forberedelsesopgave 2, hvor der **mangler** et pattern, og implementér det.

Du må kopierer koden over i en ny klasse, hvis du ikke vil risikere at ødelægge det eksisterende kode.

Skriv en kort kommentar i koden der forklarer hvilket pattern du har tilføjet og hvorfor.
